...
* [插件主页-The plug-in page on my blog](http://www.waisir.com/wp-waraPay "插件主页")
* [插件截图-Screenshots](http://wordpress.org/extend/plugins/waraPay/screenshots/)
* [反馈-Feed back](http://wordpress.org/tags/waraPay "Feed Back") 
* [相关插件-WP-Pay](http://wordpress.org/extend/plugins/wp-pay/ "富商城支持")
* [相关插件-WP-Alipay](http://wordpress.org/extend/plugins/wp-waraPay/ "")
...
= 最新版功能特性 = 
* 【多接口支持】完美支持国内通用的`支付宝`,`财付通`以及国际通用的`Paypal`接口和`20余家直联网银`!
...
== Installation ==
1. 下载(在此页面下载或者通过你的wordpress后台搜索插件waraPay-donate)并安装继而启用之.
2. 启用后到该插件的独立设置面板`控制板-设置-集成支付宝`进行相关设置.
3. 到`集成支付宝`的设置面板中点击`常规设置`,设置好您的支付宝或财付通或Paypal密钥
...
= 如何申请接口许可凭证? =
* 支付宝:请访问`支付宝官方网站`-`商家服务`-`即时到帐`进行申请.[传送门](https://b.waraPay.com/index.htm)
* 财付通:请访问[即时到帐申请页面](http://mch.tenpay.com/market/opentrans_immediately.shtml)
* Paypal:请访问Paypal官方网站,到相应的位置启用商家API
= 插件的功能太少, 可以定制其他功能吗? =
